...
export const learningPaths: LearningPath[] = [
  {
    id: 'linux-basic',
    title: 'Linux基础入门',
    description: '从0开始学Linux，运维小白的第一课。掌握文件系统、命令行、用户权限等核心概念，打下扎实的Linux基础。',
    cover: 'https://coresg-normal.trae.ai/api/ide/v1/text_to_image?prompt=linux%20penguin%20mascot%20operating%20system%20minimalist%20blue%20tech%20style&image_size=landscape_16_9',
    level: 'beginner',
    duration: 300,
    chapterCount: 10,
    studentCount: 12345,
...
`,
      },
      {
        ...
        order: 2,
        estimatedTime: 30,
        relatedLabId: 'linux-commands',
        content: `# 第2章 文件系统与目录结构
...
`,
      ...
      { id: 'ch8', title: '服务管理（systemd）', order: 8, estimatedTime: 25, content: '# 第8章 服务管理\n\n（内容待补充）' },
      { id: 'ch9', title: '日志查看与分析', order: 9, estimatedTime: 30, content: '# 第9章 日志查看与分析\n\n（内容待补充）' },
      { id: 'ch10', title: '综合实战：搭建FTP服务器', order: 10, estimatedTime: 45, content: '# 第10章 综合实战\n\n（内容待补充）' },
    ],
  },
  {
    id: 'shell-basic',
    title: 'Shell脚本入门到实战',
    description: '掌握Shell脚本编写，从变量到函数，从文本处理到自动化脚本，让重复工作一键完成。',
    cover: 'https://coresg-normal.trae.ai/api/ide/v1/text_to_image?prompt=shell%20script%20terminal%20code%20green%20hacker%20style%20dark%20background&image_size=landscape_16_9',
    level: 'beginner',
    duration: 240,
    chapterCount: 8,
    studentCount: 8234,
    ...
    tags: ['入门', 'Shell', '自动化'],
    chapters: [
      { id: 'ch1', title: 'Shell简介与第一个脚本', order: 1, estimatedTime: 25, content: '# 第1章 Shell简介与第一个脚本\n\n（内容待补充）' },
      { id: 'ch2', title: '变量与运算符', order: 2, estimatedTime: 30, content: '# 第2章 变量与运算符\n\n（内容待补充）' },
      { id: 'ch3', title: '条件判断与流程控制', order: 3, estimatedTime: 35, content: '# 第3章 条件判断与流程控制\n\n（内容待补充）' },
      { id: 'ch4', title: '循环语句', order: 4, estimatedTime: 35, content: '# 第4章 循环语句\n\n（内容待补充）' },
      { id: 'ch5', title: '函数与数组', order: 5, estimatedTime: 30, content: '# 第5章 函数与数组\n\n（内容待补充）' },
      { id: 'ch6', title: '文本处理三剑客', order: 6, estimatedTime: 40, relatedLabId: 'shell-log-analysis', content: '# 第6章 文本处理三剑客\n\n（内容待补充）' },
      { id: 'ch7', title: '正则表达式', order: 7, estimatedTime: 30, content: '# 第7章 正则表达式\n\n（内容待补充）' },
      { id: 'ch8', title: '综合实战：自动化备份脚本', order: 8, estimatedTime: 45, content: '# 第8章 综合实战\n\n（内容待补充）' },
    ],
  },
  {
    id: 'nginx-basic',
    title: 'Nginx入门到实战',
    description: '从零开始学Nginx，搞定Web服务器、反向代理、负载均衡、HTTPS配置，运维必备技能。',
    cover: 'https://coresg-normal.trae.ai/api/ide/v1/text_to_image?prompt=nginx%20web%20server%20load%20balancing%20network%20architecture%20tech&image_size=landscape_16_9',
    level: 'intermediate',
    duration: 180,
    chapterCount: 6,
    studentCount: 6789,
    ...
    tags: ['进阶', 'Nginx', 'Web服务'],
    chapters: [
      { id: 'ch1', title: 'Nginx简介与安装', order: 1, estimatedTime: 25, relatedLabId: 'nginx-install', content: '# 第1章 Nginx简介与安装\n\n（内容待补充）' },
      { id: 'ch2', title: '配置文件详解', order: 2, estimatedTime: 35, content: '# 第2章 配置文件详解\n\n（内容待补充）' },
      { id: 'ch3', title: '静态资源服务', order: 3, estimatedTime: 30, content: '# 第3章 静态资源服务\n\n（内容待补充）' },
      { id: 'ch4', title: '反向代理与负载均衡', order: 4, estimatedTime: 35, content: '# 第4章 反向代理与负载均衡\n\n（内容待补充）' },
      { id: 'ch5', title: 'HTTPS配置', order: 5, estimatedTime: 30, content: '# 第5章 HTTPS配置\n\n（内容待补充）' },
      { id: 'ch6', title: '性能调优与安全加固', order: 6, estimatedTime: 25, content: '# 第6章 性能调优与安全加固\n\n（内容待补充）' },
    ],
  },
  {
    id: 'docker-basic',
    title: 'Docker快速入门',
    description: '容器化时代必学技术，Docker基础命令、镜像构建、容器编排，迈向云原生第一步。',
    cover: 'https://coresg-normal.trae.ai/api/ide/v1/text_to_image?prompt=docker%20container%20whale%20cloud%20native%20blue%20minimalist&image_size=landscape_16_9',
    level: 'intermediate',
    duration: 240,
    chapterCount: 8,
    studentCount: 5432,
    ...
    tags: ['进阶', 'Docker', '云原生'],
    chapters: [
      { id: 'ch1', title: 'Docker简介与安装', order: 1, estimatedTime: 30, relatedLabId: 'docker-quickstart', content: '# 第1章 Docker简介与安装\n\n（内容待补充）' },
      { id: 'ch2', title: '镜像与容器基础', order: 2, estimatedTime: 35, content: '# 第2章 镜像与容器基础\n\n（内容待补充）' },
      { id: 'ch3', title: 'Dockerfile详解', order: 3, estimatedTime: 40, content: '# 第3章 Dockerfile详解\n\n（内容待补充）' },
      { id: 'ch4', title: '数据卷与网络', order: 4, estimatedTime: 35, content: '# 第4章 数据卷与网络\n\n（内容待补充）' },
      { id: 'ch5', title: 'Docker Compose', order: 5, estimatedTime: 35, content: '# 第5章 Docker Compose\n\n（内容待补充）' },
      { id: 'ch6', title: '镜像仓库', order: 6, estimatedTime: 25, content: '# 第6章 镜像仓库\n\n（内容待补充）' },
      { id: 'ch7', title: '实战：部署WordPress', order: 7, estimatedTime: 20, content: '# 第7章 实战：部署WordPress\n\n（内容待补充）' },
      { id: 'ch8', title: 'Docker安全最佳实践', order: 8, estimatedTime: 20, content: '# 第8章 Docker安全最佳实践\n\n（内容待补充）' },
    ],
  },
];
